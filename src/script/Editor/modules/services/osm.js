...
import parseosm from '../../utils/parseosm'
...
var urlroot = 'http://bt1.geosts.ac.cn/api/dae/datastore/rest/v0.1.0/datastore/'
var oauth = osmAuth({
    url: urlroot,
...
export default {
            ...
            // else, no retry..
                ...
                if (callback) {
                    if (err) {
                        ...
                        return parseosm(xml,callback,options);
    ...
    loadTiles: function(projection, callback) {
        ...
        tiles.forEach(function(tile) {
            ...
            let minx = tile.extent[0][0]
            let miny = tile.extent[0][1]
            ...
            _tileCache.inflight[tile.id] = that.loadFromAPI(str,function (err, parsed) {
                delete _tileCache.inflight[tile.id]
                if (!err) {
                    _tileCache.loaded[tile.id] = true
                }
